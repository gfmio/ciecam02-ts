...
describe("Roundtrips", function () {
	var rgb = require("ciebase-ts").rgb,
	    xyz = require("ciebase-ts").xyz(),
	    cam = require("../lib/cam").default(),
	    ucs = require("../lib/ucs").default(),
	    hq = require("../lib/hq"),
	    hex = "#e73e01",
	    RGB = rgb.fromHex(hex),
	    XYZ = xyz.fromRgb(RGB),
...
describe("Gamut", function () {
	var rgb = require("ciebase-ts").rgb,
	    xyz = require("ciebase-ts").xyz(),
	    cam = require("../lib/cam").default(),
	    gamut = require("../lib/gamut").default(xyz, cam),
...
describe("Fairchild examples", function () {
	var CamConv = require("../lib/cam").default;
	it("Case 1", function () {
		var cc = CamConv({
