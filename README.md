...
It is a TypeScript port of [@baskerville/ciecam02](https://github.com/baskerville/ciecam02) with slight modifications (removed dependency, cleaned up code) and TypeScript declarations.
...
See also [this source file](./test/test.ts).
